...
export const projects: Project[] = [
  { slug: 'fyp', code: 'FYP-01', title: 'EMG-Controlled Prosthetic Arm', label: 'FINAL YEAR PROJECT', summary: 'A 3D-printed HACKberry prosthetic arm with EMG control, sensory feedback, safety responses, and an ESP32-based control system.', description: 'Developed a modified HACKberry prosthetic arm controlled by surface EMG signals. The Phase 2 system combines an ESP32, servo-driven movement, thermistor and piezoelectric sensing, vibration feedback, safety responses, and a web-based calibration dashboard.', year: '2026', status: 'Final year project', category: 'Embedded Systems', tags: ['ESP32', 'EMG', 'Sensors', 'Dashboard'], accent: 'red', image: '/images/projects/fyp/cad-side-view.png', gallery: ['/images/projects/fyp-prosthetic-arm.jpg', '/images/projects/fyp-assembly.jpg', '/images/projects/fyp-testing.jpg'], galleryItems: [
    { image: '/images/projects/fyp/cad-rear-view.png', code: 'FYP-02', title: 'CAD design — rear assembly', label: 'MECHANICAL DESIGN', description: 'The rear view shows the hand housing, finger linkages, wrist interface, and forearm enclosure designed around the internal actuators and electronics.' },
    { image: '/images/projects/fyp/system-architecture.png', code: 'FYP-03', title: 'Updated system architecture', label: 'SYSTEM ARCHITECTURE', description: 'This block diagram traces muscle input through single-channel EMG acquisition and ESP32 processing, then into sensing, calibration, dashboard, control, actuation, and vibration feedback.' },
    { image: '/images/projects/fyp/emg-dashboard.png', code: 'FYP-04', title: 'EMGARM calibration dashboard', label: 'SOFTWARE INTERFACE', description: 'The dashboard presents the live EMG envelope, pulse and curve features, calibration values, and training states used while configuring different prosthetic gestures.' },
    { image: '/images/projects/fyp/emg-test.png', code: 'FYP-05', title: 'Live EMG signal test', label: 'EXPERIMENTAL TESTING', description: 'Surface EMG electrodes are connected during a live test while muscle activation data is streamed to the dashboard for signal inspection and gesture classification.' },
    { image: '/images/projects/fyp/prototype.jpg', code: 'FYP-06', title: 'Integrated physical prototype', label: 'SYSTEM INTEGRATION', description: 'The assembled 3D-printed prototype shows the hand, forearm casing, wrist module, and embedded hardware together during system integration.' },
    { image: '/images/projects/fyp/distance-response.png', code: 'FYP-07', title: 'Distance response results', label: 'RESULTS / VALIDATION', description: 'This plot records the measured thumb-index distance across 30 trials, providing a visual record of the prosthetic movement response during testing.' },
  ] },
...
export const fypSections = [
  ...
  ['System design', 'The system combines EMG input, signal conditioning, digital processing, ESP32 control, hand actuation, thermistors, pressure sensors, vibration feedback, and an online dashboard.'],
  ...
  ['Testing and results', 'The control response was tested and refined across repeated trials. The distance-response plot records the measured thumb-index movement across the test sequence.'],
